/*
 * EasyMiner - SHA-256 Types
 * Common types for mining operations
 *
...
// SHA-256 hash result (256 bits = 32 bytes = 8 x 32-bit words)
typedef union {
    uint32_t hash[8];
    uint8_t bytes[32];
} sha256_hash_t;
