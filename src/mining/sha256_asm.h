 ...
 *
 * @EasyMiner\.pio\libdeps\esp32-s3-mini\WiFiManager\examples\ParamsChildClass\ParamsChildClass.ino sha_base       SHA_TEXT_BASE register address
 * @EasyMiner\.pio\libdeps\esp32-s3-mini\WiFiManager\examples\ParamsChildClass\ParamsChildClass.ino header_swapped Pre-byteswapped 80-byte header
 * @EasyMiner\.pio\libdeps\esp32-s3-mini\WiFiManager\examples\ParamsChildClass\ParamsChildClass.ino nonce_ptr      Pointer to nonce (updated)
 * @EasyMiner\.pio\libdeps\esp32-s3-mini\WiFiManager\examples\ParamsChildClass\ParamsChildClass.ino hash_count_ptr Pointer to hash counter
 * @EasyMiner\.pio\libdeps\esp32-s3-mini\WiFiManager\examples\ParamsChildClass\ParamsChildClass.ino mining_flag    Pointer to mining active flag
 *
